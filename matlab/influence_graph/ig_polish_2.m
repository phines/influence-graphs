...
%addpath('../polish_results/before_after/');
opt = psoptions;
C = psconstants;
% load the case data
load case2383_mod_ps_before;
...
max_delta_t = 20;
[~,user_name] = unix('echo $USER');
user_name = user_name(1:end-1); % to exclude the enter at the end of the line 
in_dir = sprintf('/Users/%s/Google Drive/Influence/polish_results/k2',user_name);
file_root = 'all_k2_loadprc_100';
output_dir = '../polish_results/before/';
...
out_filename = sprintf('ig_polish_results_delta_t_%d',max_delta_t);
save(out_filename)
return
