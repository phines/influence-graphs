function sim_all_n2s_mod(set_no,n_subsets,casename,loadprc)
% Simulate all possible n-2 sequences (defaults to the Polish case)
% In the modified version, the rating of five critical lines are doubled.
